# This Makefile is for the HTML::Seamstress extension to perl.
#
...
FULLEXT = HTML/Seamstress
BASEEXT = Seamstress
PARENT_NAME = HTML
DLBASE = $(BASEEXT)
VERSION_FROM = lib/HTML/Seamstress.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/HTML/Seamstress.pod \
	lib/XML/Seamstress.pm
...
TO_INST_PM = lib/HTML/Seamstress.pm \
	lib/HTML/Seamstress.pod \
	lib/HTML/Seamstress/Compiler.pm \
	lib/XML/Seamstress.pm

PM_TO_BLIB = lib/HTML/Seamstress/Compiler.pm \
	blib/lib/HTML/Seamstress/Compiler.pm \
	lib/HTML/Seamstress.pm \
	blib/lib/HTML/Seamstress.pm \
	lib/XML/Seamstress.pm \
	blib/lib/XML/Seamstress.pm \
	lib/HTML/Seamstress.pod \
	blib/lib/HTML/Seamstress.pod
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3pm --perm_rw=$(PERM_RW)\
	  lib/XML/Seamstress.pm $(INST_MAN3DIR)/XML::Seamstress.$(MAN3EXT) \
	  lib/HTML/Seamstress.pod $(INST_MAN3DIR)/HTML::Seamstress.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  blib/lib/HTML/Seamstress.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE) blib/lib/XML/Seamstress.pm blib/lib/HTML/Seamstress.pod blib/lib/HTML/Seamstress/Compiler.pm
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  lib/HTML/Seamstress/Compiler.pm blib/lib/HTML/Seamstress/Compiler.pm \
	  lib/HTML/Seamstress.pm blib/lib/HTML/Seamstress.pm \
	  lib/XML/Seamstress.pm blib/lib/XML/Seamstress.pm \
	  lib/HTML/Seamstress.pod blib/lib/HTML/Seamstress.pod 
	$(NOECHO) $(TOUCH) $@
